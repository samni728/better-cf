...
func TestRunPlanFreezesManualPriorityPrefixAndCandidateBudget(t *testing.T) {
	...
	if !reflect.DeepEqual(searchPlan[0].ManualSeedIPs, []string{"172.66.130.219"}) || !reflect.DeepEqual(searchPlan[0].ManualHintPrefixes, []string{"172.66.130.0/24", "172.66.0.0/16"}) || searchPlan[0].ManualQuotaPercent != 100 || !searchPlan[0].ManualExclusive {
